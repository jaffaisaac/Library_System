  ...
  const formSubmit = (e) => {
    ...
    addDoc(collRef, {
      ...
      .then((docRef) => {
        ...
        setSelectedImage(null);
        navigate("/login");
        navigate('/allbooks',{state :{userID:FormData.id,username:FormData.FName}})
      })
      ...
      <form ref={formRef}>
        <div className="formInputSection">
          ...
          <div className="inputsOnly">
            <input type="text" placeholder="Enter ID" name="id"   value={FormData.id} onChange={handleInputChange} required />
            ...
            <div className="fromGroup">
              <select
                name="courseOption"
                value={FormData.courseSelectedOption}
                onChange={handleInputChange}
              >
                <option>Select Course</option>
                <option value="Education">Education</option>
                <option value="Health &  Managment">Health & managment</option>
                <option value="Business & Managment">
                  Business & Managment
                </option>
                ...
                <option value="Language & Linguistcs">
                  Language & Linguistcs
                </option>
              </select>
          ...
          <div className="profile">
            <img
              src={selectedImage}
              alt=" ____selecte your profile picture____ "
            />
          </div>
        </div>
